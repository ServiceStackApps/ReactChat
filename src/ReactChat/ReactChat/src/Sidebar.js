            ...
            Sidebar = (function (_super) {
                ...
                Sidebar = __decorate([
                    utils_1.reduxify(function (state) { return ({
                        ...
                        selectUser: function (user) { return dispatch({ type: 'USERS_SELECT', user: user }); },
